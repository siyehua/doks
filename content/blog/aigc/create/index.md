---
title: "Create Stable Diffusion 使用方式"
...
申请谷歌云盘：<br>
![google 硬盘](/images/use_sd_type/google_drive.png)<br><br>
打开这里：[stable-diffusion-webui-colab](https://github.com/camenduru/stable-diffusion-webui-colab)
![google 硬盘](/images/use_sd_type/google_drive_2.png)<br><br>
点击左上角的运行按钮：<br>
![google 硬盘](/images/use_sd_type/google_drive_3.png)<br><br>
运行的时候会弹出警告，大概得意思是，现在谷歌没钱了，GPU 可能不能免费给你用了，点：`仍然继续`:<br>
![google 硬盘](/images/use_sd_type/google_drive_4.png)<br><br>
等完成之后，就能看到链接了:<br>
![google 硬盘](/images/use_sd_type/google_drive_5.png)<br><br>
