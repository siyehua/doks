...
* [RAG 基础：先认识与了解 RAG](/blog/rag基础打造知识库1)
* [向量数据库入门](/blog/向量数据库打造知识库2)
* [本地部署大模型（可选）]((/blog/本地大模型-一文了解-ollama))
* [大模型 API 调用(可选)](/blog/本地大模型-一调用API)
* [文件转向量存储到向量数据库](/blog/文本转向量打造知识库3)
* [提问结合向量数据库知识](/blog/文件处理打造知识库4)
