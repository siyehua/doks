...
如果你想入门 AI 绘画，看到这里就基本差不多了，但你是一个 AI绘画开发者，你还要学会如何使用接口与调整参数。<br>
前文已经讲到，实际上我们可以直接将 SD 项目的能力封装成各种借口给业务调用，但是这非常复杂，好在 WebUI 本身已经封装好了，可以看[GPU云服务器安装StableDiffusion](/blog/gpu云服务器安装stablediffusion)
